...
systematic_number: '790.552'
title: Verordnung über das Naturschutzgebiet «Rehhagweid-Lauchweid», Langenbruck und
  Eptingen
...
#  Verordnung
über das Naturschutzgebiet «Rehhagweid-Lauchweid», Langenbruck und Eptingen
...
Für das Naturschutzgebiet gelten folgende Schutzziele:
  ...
  * a) Erhaltung und Förderung der «Rehhagweid-Lauchweid» als Magerweide von nationaler Bedeutung mit ihren spezifischen Lebensgemeinschaften;

  * b) Erhaltung und Förderung von Dorngebüschen, wertvollen Einzelbäumen, Waldinseln und Kleinstrukturen im Offenland;

  * c) Erhaltung einer Teilfläche als ungenutztes und unberührtes Waldgebiet (Totalwaldreservat) mit eigendynamischer Waldentwicklung als Lebensraum für störungsempfindliche Arten;

  * d) Förderung lichter Waldbestände als Lebensraum für Licht und Wärme liebende Tier- und Pflanzenarten;

  * e) Erhaltung und Förderung des Biotop-Verbunds für Tagfalter, Widderchen und kleine Säugetiere, insbesondere mit der Verzahnung von Wald und Offenland;

  * f) Erhaltung und Förderung der seltenen und der geschützten Tier- und Pflanzenarten gemäss Artenliste im Anhang sowie generell der Arten der Trockenwiesen und -weiden.
...
Verboten sind insbesondere:
  ...
  * g) das Radfahren, Biken und Reiten sowie das unberechtigte Befahren mit Motorfahrzeugen ausser zu forstlichen oder landwirtschaftlichen Zwecken abseits der erlaubten Wege;
...
Als Ausnahme vom Veranstaltungsverbot gemäss § 3 Abs. 2 Bst. c bleibt die Nutzung der Wege erlaubt.
...
##  Anhänge
  ...
  * [Anhang 1: Perimeter Naturschutzgebiet «Rehhagweid-Lauchweid», Langenbruck und Eptingen](<https://bl.clex.ch/api/annex_document_dictionaries/26017>)
  * [Anhang 2: Artenliste Naturschutzgebiet «Rehhagweid-Lauchweid», Langenbruck und Eptingen](<https://bl.clex.ch/api/annex_document_dictionaries/26018>)

  1. [1] [SGS 100](<https://bl.clex.ch/data/100/de/art74>)
  2. [2] [SGS 790](<https://bl.clex.ch/data/790/de>)
  3. [3] [SGS 790](<https://bl.clex.ch/data/790/de/art17>)
