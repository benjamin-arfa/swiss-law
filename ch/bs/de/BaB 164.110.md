...
##  Anhänge
  ...
  * [Anhang BaB 164.110 ***** : Anhang Reglement zur Lohnordnung](<https://www.gesetzessammlung.bs.ch/api/annex_document_dictionaries/15506>)

  1. [1] [BaB 164.100](<https://www.gesetzessammlung.bs.ch/data/BaB%20164.100/de>).
  2. [2] Softwarebedingte, redaktionelle Einfügung von Gliederungsziffern oder -buchstaben.
  3. [3] § 5 Abs. 1: Einleitungssatz redaktionell eingefügt.
  4. [4] § 6 Abs. 2: Das Verzeichnis der Musterfunktionen und das Einreihungsschema werden hier nicht abgedruckt; sie können beim Bürgerratsschreiber (Stadthaus) eingesehen werden (Fussnote ist Bestandteil dieses Erlasses).
