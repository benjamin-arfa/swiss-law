...
**Art. 29** Art. 29 Contenu des déclarations à faire par les animaleries

1 Les déclarations à faire par les animaleries doivent contenir les informations suivantes:a. le nombre des animaux nés dans l’établissement, comptés au moment du sevrage;b. le nombre des animaux importés de l’étranger.
...
4 Si les lignées ne présentent pas de phénotype invalidant, elles doivent être déclarées, pour chaque espèce animale, en regroupant:a. les lignées génétiquement modifiées;b. les lignées non génétiquement modifiées.
