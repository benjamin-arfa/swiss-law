---
abbreviation: Schutzbeschluss Chli Gäsitschachen
canton: GL
category_type: Anderes
global_category: 7.70.50 Naturschutz
language: de
source: LexWork
systematic_category: IV G/5 Schutzgebiete
systematic_number: IV G/5/10
title: Beschluss über den Schutz des Chli Gäsitschachens
...
Es werden folgende Zonen ausgeschieden:
  ...
  * c) Zone 3: Artenförderung;

  * d) Zone 4: Pufferzone;

  * e) Zone 5: übrige Fläche.
...
Insbesondere sind verboten:
  ...
  * a) das Errichten von Bauten und Anlagen aller Art (Gebäude, Mauern, Reklamevorrichtungen, Antennen, Freileitungen und dergleichen), die nicht zwingend für die bestimmungsgemässe Nutzung des Gebietes notwendig sind oder ausserhalb des Schutzgebietes realisiert werden könnten;
  ...
  * i) das Pflücken, Sammeln, Ausgraben oder Zerstören von wildwachsenden Pflanzen und Pilzen;
  ...
  * o) das Befahren der Gewässer mit Booten und Schwimmkörpern aller Art sowie das Anlanden am Ufer und an den Inseln;

  * p) die Durchführung von kommerziellen oder öffentlich ausgeschriebenen Sport- und Freizeitveranstaltungen.
...
**Art. 4**
Besondere Vorschriften für die Zone 1 (Aufweitung)
...
**Art. 5**
Besondere Vorschriften für die Zone 2 (Kernzone)
...
**Art. 6**
Besondere Vorschriften für die Zone 3 (Artenförderung)
...
**Art. 7**
Besondere Vorschriften für die Zone 4 (Pufferzone)
...
**Art. 8**
Besondere Vorschriften für die Zone 5 (übrige Flächen)
...
In den Zonen 3 (Artenförderung) und 4 (Pufferzonen) gelten auf dem Gebiet des Schiessplatzes Walenberg folgende Ausnahmeregelungen:
  ...
  * a) Die militärische Nutzung gemäss den militärischen Vorgaben und Zielen ist gewährleistet;

  * b) Der Unterhalt, die Erneuerung, der Wiederaufbau und die massvolle Erweiterung der militärischen Einrichtungen ist gewährleistet;

  * c) Unterhalt und Pflege erfolgen gemäss den Vorgaben des jeweils geltenden Programmes Natur Landschaft Armee (NLA) für den Schiessplatz Walenberg.
...
##  Anhänge
  ...
  * [Anhang 1: Schutzzonenplan](<https://gesetze.gl.ch/api/annex_document_dictionaries/549>)

  1. [1] [GS IV G/1/1](<https://gesetze.gl.ch/data/GS-IV-G.1.1/de>)
  2. [2] SR 451
  3. [3] SR 451.34
  4. [4] GS [VII B/55/2](<https://gesetze.gl.ch/data/VII-B.55.2/de>)
  5. [5] GS [IV G/1/2](<https://gesetze.gl.ch/data/IV-G.1.2/de>)
