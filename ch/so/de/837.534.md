...
#  Verwaltungsreglement über den kantonalen Fonds für die Prävention und Bekämpfung der Spielsucht
...
GS 104, 127
  ...
  2. [2] BGS [811.1](<https://bgs.so.ch/data/811.1/de>).
  3. [3] BGS [513.633.3](<https://bgs.so.ch/data/513.633.3/de>).
  4. [4] BGS [513.633.3](<https://bgs.so.ch/data/513.633.3/de>).
